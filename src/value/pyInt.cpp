...
PyInt::PyInt(lld v) : PyObject(ObjectType::Int, new lld(v)) {}
...
void PyInt::registerMethods() {
  ...
  this->define(
      "__mod__", new PyFunction([](std::vector<PyObject *> args,
                                   Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__lshift__", new PyFunction([](std::vector<PyObject *> args,
                                      Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__rshift__", new PyFunction([](std::vector<PyObject *> args,
                                      Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
