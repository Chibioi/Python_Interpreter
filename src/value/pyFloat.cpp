...
PyFloat::PyFloat(llf v) : PyObject(ObjectType::Float, new llf(v)) {}

void PyFloat::registerMethods() {

  this->define("__float__",
               new PyFunction([](std::vector<PyObject *> args,
  ...
  this->define(
      "__add__", new PyFunction([](std::vector<PyObject *> args,
                                   Interpreter *interpreter) -> PyObject * {
  ...
  this->define(
      "__sub__", new PyFunction([](std::vector<PyObject *> args,
                                   Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__mul__", new PyFunction([](std::vector<PyObject *> args,
                                   Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__truediv__", new PyFunction([](std::vector<PyObject *> args,
                                       Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  /*this->define("__mod__",
      new PyFunction([](std::vector<PyObject*> args, Interpreter* interpreter)
  -> PyObject* {
  ...
  this->define(
      "__lt__", new PyFunction([](std::vector<PyObject *> args,
                                  Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__gt__", new PyFunction([](std::vector<PyObject *> args,
                                  Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__le__", new PyFunction([](std::vector<PyObject *> args,
                                  Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__ge__", new PyFunction([](std::vector<PyObject *> args,
                                  Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__eq__", new PyFunction([](std::vector<PyObject *> args,
                                  Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
  ...
  this->define(
      "__ne__", new PyFunction([](std::vector<PyObject *> args,
                                  Interpreter *interpreter) -> PyObject * {
        ASSERT_ARG_SIZE(args, 2);
